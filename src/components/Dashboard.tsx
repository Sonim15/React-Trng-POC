      ...
      <div>
        <div>
          ...
          <div className="header">
            ...
            <div><h5>Last Login : 21-Sept-2020</h5></div>
        ...
        <div className="account-balance"><h3>Account Balance: &#x20B9;8000</h3></div>
        <table className="ui celled fixed single line table">
          ...
          <tbody className="">
            <tr className="">
              <td className="">21-Sept-2020</td>
              <td className="">Transportation</td>
              <td className="">5000</td>
            </tr>
            <tr className="">
              <td className="">21-Sept-2020</td>
              <td className="">Weekend Expenses</td>
...
function Dashboard () {
    return (
        <div>
          <div>
            <div className="header">
              <div className="d4"> <div> <h3>Welcome Home</h3></div>
